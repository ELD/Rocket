...
use crate::http::uri::fmt::{Query, UriDisplay};
...
impl<'v> LocalForm<'v> {
    ...
    where
        N: Into<NameBuf<'v>>,
        V: Into<String> + UriDisplay<Query>,
    {
    ...
    pub fn content_type(&self) -> ContentType {
        ...
        {
            return ContentType::new("multipart", "form-data")
    ...
    where
        ...
        V: Into<String>,
    {
        self.0.push(LocalField::Value(name.into(), value.into()));
    }
...
mod test {
    ...
    fn test_content_type() {
        let form = LocalForm::new().field("name[]", "john doe");
    ...
    fn test_body_data() {
        ...
        assert_eq!(
            multipart_body.as_str(),
            String::from_utf8_lossy(&form.body_data())
        );
    }
    ...
    fn test_raw_field() {
        ...
        let form = LocalForm::new().raw_field(RawStr::new("is%20it"), RawStr::new("a%20cat%3F"));
